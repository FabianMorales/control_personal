...
class myEnrutador {
    ...
    public static function boot() {
        ...
        $app->post('/usuario/validar', myControlador::_("Sesion@iniciarSesion"));
        ...
        $app->get('/sesion', myControlador::_("Sesion@index"));
        $app->get('/sesion/salir', myControlador::_("Sesion@finalizarSesion"));
        ...
        $app->get('/files/backup', myControlador::_("Flujo@crearBackup"));
